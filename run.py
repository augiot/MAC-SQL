...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_mode', type=str, default='test', choices=['train', 'dev', 'test'], help='dataset mode')
    parser.add_argument('--input_file', type=str, default='./data/foo/test.json', required=False, help='path to dataset input')
    parser.add_argument('--db_path', type=str, default='./data/foo/test_databases', required=False, help='path to databases in dataset')
    parser.add_argument('--tables_json_path', type=str, default='./data/foo/test_tables.json', help='path to tables.json')
    parser.add_argument('--output_file', type=str, default='./outputs/foo/output_bird.json', required=False, help='path to predicted output')
    parser.add_argument('--log_file', type=str, default='./outputs/foo/log.txt', help='path to log file if needed')
